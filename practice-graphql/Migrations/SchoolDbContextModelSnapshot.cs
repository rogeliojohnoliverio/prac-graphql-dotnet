...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudentDTOSubjectDTO", b =>
                {
                    ...
                    b.ToTable("StudentDTOSubjectDTO", (string)null);
            ...
            modelBuilder.Entity("practice_graphql.DTOs.InstructorDTO", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("practice_graphql.DTOs.StudentDTO", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("practice_graphql.DTOs.SubjectDTO", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("StudentDTOSubjectDTO", b =>
                {
                    b.HasOne("practice_graphql.DTOs.StudentDTO", null)
                        .WithMany()
                        .HasForeignKey("StudentsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("practice_graphql.DTOs.SubjectDTO", null)
                        .WithMany()
            ...
            modelBuilder.Entity("practice_graphql.DTOs.SubjectDTO", b =>
                {
                    b.HasOne("practice_graphql.DTOs.InstructorDTO", "Instructor")
                        .WithMany("Subjects")
